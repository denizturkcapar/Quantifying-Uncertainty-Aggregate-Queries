...
bipartite_graph_maximal = one_to_one.updated_maximal_construct_graph("table_a.csv","table_b.csv")
#print(bipartite_graph_maximal.edges.data())
bipartite_graph_minimal = one_to_one.updated_minimal_construct_graph("table_a.csv", "table_b.csv")
...
table_a = one_to_one.convert_df("ACM.csv")

table_b = one_to_one.convert_df("DBLP2.csv")

now = datetime.datetime.now()
graph_maximal = one_to_one.updated_maximal_construct_graph(table_a, table_b)
...
now = datetime.datetime.now()
treshold_graph_maximal = one_to_one.treshold_updated_maximal_construct_graph(table_a, table_b, 0.3)
...
perfect_mapping = one_to_one.convert_df("DBLP-ACM_perfectMapping.csv")
...
lowered_tresh_graph = one_to_one.treshold_updated_maximal_construct_graph(table_a, table_b, 0.25)
