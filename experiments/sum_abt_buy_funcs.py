...
def realdata_sum_bip_script(table_a_non_duplicated, table_b, column_name, similarity_threshold, n_matches, tables_map, num_swaps=None):
	...
	bipartite_graph_result = one_to_n.valcomp_treshold_graph_construct_abt_buy_sum(table_a_non_duplicated, table_b, column_name, similarity_threshold, n_matches)
	...
	now = datetime.datetime.now()
	min_bipartite_graph_result = one_to_n.valcomp_treshold_graph_construct_abt_buy_sum(table_a_non_duplicated, table_b, column_name, similarity_threshold, n_matches)
...
def full_evaluation(bp_min,bp_max, naive_min,naive_max, sampled_min,sampled_max, perfect_mapping, perf_match_dict):
...
def show_experiment_1_sum(file1, file2, perf_match_file, experiment_name, sim_thresh, true_n, max_n):
	...
	label_list = ['Bipartite Matching', 'PC Matching', 'Sample Matching']
