...
def show_experiment_1(results_file, experiment_name):
...
def experiment2_width_helper(results_file):
...
def show_experiment_2_balanced(experiment_name, sim_thresh, is_age_skewed=False, num_swaps=None):
	...
	#1-2
	bp_width2, naive_width2, sampled_width2 = experiment2_width_helper("balanced_2_n2")
	#1-3
	bp_width3, naive_width3, sampled_width3 = experiment2_width_helper("balanced_2_n3")
	#1-4
	bp_width4, naive_width4, sampled_width4 = experiment2_width_helper("balanced_2_n4")
	#1-5
	bp_width5, naive_width5, sampled_width5 = experiment2_width_helper("balanced_2_n5")
	#1-6
	bp_width6, naive_width6, sampled_width6 = experiment2_width_helper("balanced_2_n6")
...
def show_experiment_2_skewed(experiment_name, sim_thresh, is_age_skewed=False, num_swaps=None):
	...
	#1-2
	bp_width2, naive_width2, sampled_width2 = experiment2_width_helper("skewed_2_n2")
	#1-3
	bp_width3, naive_width3, sampled_width3 = experiment2_width_helper("skewed_2_n3")
	#1-4
	bp_width4, naive_width4, sampled_width4 = experiment2_width_helper("skewed_2_n4")
	#1-5
	bp_width5, naive_width5, sampled_width5 = experiment2_width_helper("skewed_2_n5")
	#1-6
	bp_width6, naive_width6, sampled_width6 = experiment2_width_helper("skewed_2_n6")
...
def experiment_3_acc_helper(results_file):
	df1 = pd.read_csv('{}.csv'.format(results_file))
	bp_min_med = df1['Bipartite Min Matching'].median()
	bp_max_med = df1['Bipartite Max Matching'].median()
	bp_avg = (bp_min_med + bp_max_med)/2
	naive_min_med = df1['Naive Min Matching'].median()
	naive_max_med = df1['Naive Max Matching'].median()
	naive_avg = (naive_min_med + naive_max_med)/2
	sampled_min_med = df1['Sampled Min Matching'].median()
	sampled_max_med = df1['Sampled Max Matching'].median()
...
def show_experiment_3(experiment_name, sim_thresh, is_age_skewed=False, num_swaps=None):
	...
	# skew level = 1
	bp_width1, naive_width1, sampled_width1 = experiment2_width_helper("skewed_3_skew1")
	# skew level = 3
	bp_width2, naive_width2, sampled_width2 = experiment2_width_helper("skewed_3_skew3")
	# skew level = 5
	bp_width3, naive_width3, sampled_width3 = experiment2_width_helper("skewed_3_skew5")
	# skew level = 7
	bp_width4, naive_width4, sampled_width4 = experiment2_width_helper("skewed_3_skew7")
	# skew level = 9
	bp_width5, naive_width5, sampled_width5 = experiment2_width_helper("skewed_3_skew9")
	# skew level = 11
	bp_width6, naive_width6, sampled_width6 = experiment2_width_helper("skewed_3_skew11")
...
def show_experiment_4_balanced(experiment_name, user_n, is_age_skewed=False, num_swaps=None):
	...
	bp_width1, naive_width1, sampled_width1 = experiment2_width_helper("1_exp4_balanced")
	# sim thresh level = 2
	bp_width2, naive_width2, sampled_width2 = experiment2_width_helper("2_exp4_balanced")
	# sim thresh level = 3
	bp_width3, naive_width3, sampled_width3 = experiment2_width_helper("3_exp4_balanced")
	# sim thresh level = 4
	bp_width4, naive_width4, sampled_width4 = experiment2_width_helper("4_exp4_balanced")
	# sim thresh level = 5, worst
	bp_width5, naive_width5, sampled_width5 = experiment2_width_helper("5_exp4_balanced")
	# sim thresh level = 6
	# bp_width6, naive_width6, sampled_width6 = experiment2_width_helper("6_exp4_balanced")

	# # sim thresh level = 7, worst
	# bp_width7, naive_width7, sampled_width7 = experiment2_width_helper("6_exp4_balanced")
...
def show_experiment_4_skewed(experiment_name, user_n, is_age_skewed=False, num_swaps=None):
	create_skewed_1_to_n_sum_results("1_exp4_skewed", 0.2,0.2,0.2,user_n,user_n,user_n,user_n,100,100, is_age_skewed, num_swaps)
	create_skewed_1_to_n_sum_results("2_exp4_skewed", 0.17,0.17,0.17,user_n,user_n,user_n,user_n,100,150, is_age_skewed, num_swaps)
	create_skewed_1_to_n_sum_results("3_exp4_skewed", 0.14,0.14,0.14,user_n,user_n,user_n,user_n,100,200, is_age_skewed, num_swaps)
	create_skewed_1_to_n_sum_results("4_exp4_skewed", 0.11,0.11,0.11,user_n,user_n,user_n,user_n,100,250, is_age_skewed, num_swaps)
	create_skewed_1_to_n_sum_results("5_exp4_skewed", 0.08,0.08,0.08,user_n,user_n,user_n,user_n,100,225, is_age_skewed, num_swaps)
	# create_skewed_1_to_n_sum_results("6_exp4_skewed_n5", 0.06,0.06,0.06,user_n,user_n,user_n,user_n,100,300, is_age_skewed, num_swaps)
	# create_skewed_1_to_n_sum_results("6_exp4_skewed_n5", 0.02,0.02,0.02,user_n,user_n,user_n,user_n,100,300, is_age_skewed, num_swaps)

	# sim thresh level = 1, optimal
	bp_width1, naive_width1, sampled_width1 = experiment2_width_helper("1_exp4_skewed")
	# sim thresh level = 2
	bp_width2, naive_width2, sampled_width2 = experiment2_width_helper("2_exp4_skewed")
	# sim thresh level = 3
	bp_width3, naive_width3, sampled_width3 = experiment2_width_helper("3_exp4_skewed")
	# sim thresh level = 4
	bp_width4, naive_width4, sampled_width4 = experiment2_width_helper("4_exp4_skewed")
	# sim thresh level = 5, worst
	bp_width5, naive_width5, sampled_width5 = experiment2_width_helper("5_exp4_skewed")
	# sim thresh level = 6, worst
	# bp_width6, naive_width6, sampled_width6 = experiment2_width_helper("6_exp4_skewed")
	# sim thresh level = 7, worst
	# bp_width7, naive_width7, sampled_width7 = experiment2_width_helper("6_exp4_skewed")
...
def show_experiment_5_balanced(experiment_name, user_n, sim_thresh, is_age_skewed=False):
	...
	# sim thresh level = 2
	bp_width2, naive_width2, sampled_width2 = experiment2_width_helper("50_exp5_skewed")
	# sim thresh level = 3
	bp_width3, naive_width3, sampled_width3 = experiment2_width_helper("75_exp5_skewed")
	# sim thresh level = 4
	bp_width4, naive_width4, sampled_width4 = experiment2_width_helper("100_exp5_skewed")
	# sim thresh level = 5, worst
	bp_width5, naive_width5, sampled_width5 = experiment2_width_helper("125_exp5_skewed")
	# sim thresh level = 6, worst
	bp_width6, naive_width6, sampled_width6 = experiment2_width_helper("150_exp4_skewed")
	# sim thresh level = 7, worst
	bp_width7, naive_width7, sampled_width7 = experiment2_width_helper("175_exp4_skewed")
